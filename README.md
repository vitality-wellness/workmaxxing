...
Then add the hooks to your repo's `.claude/settings.local.json` (or `.claude/settings.json`):
...
All hooks point to the same `powr-hook.sh` file with different handler arguments.
