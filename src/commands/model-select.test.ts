...
describe("selectModel: powr-investigate", () => {
  it("returns haiku when estimate is 1", () => {
  ...
  it("returns haiku when estimate is 0", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns haiku when labels include bug-fix", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns haiku when labels include Bug-Fix (case-insensitive)", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns sonnet when estimate is 3 and no bug-fix label", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns sonnet when estimate is 5", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns sonnet when estimate is null (fallback)", () => {
    const result = selectModel(
      "powr-investigate",
  ...
  it("returns sonnet when both estimate and labels are null", () => {
...
describe("selectModel: powr-code-review", () => {
  it("returns haiku for 1 file with 30 total changed lines", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns haiku for 1 file with 0 changed lines", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns haiku for 1 file with 49 total changed lines (boundary)", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns sonnet for 1 file with exactly 50 total changed lines (boundary)", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns sonnet for 1 file with 60 total changed lines", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns sonnet for 2 files even with small diff", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns sonnet for 5 files with large diff", () => {
    const result = selectModel(
      "powr-code-review",
      baseSignals({
  ...
  it("returns sonnet when diffStats is null (fallback)", () => {
    const result = selectModel(
      "powr-code-review",
...
describe("selectModel: powr-ship-verify", () => {
  it("returns haiku for 1 ticket with all gates passed", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns haiku for 2 tickets with all gates passed", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet for 3 tickets even with all gates passed", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet for 2 tickets with failed gates", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet for 1 ticket with failed gates", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet when ticketCount is null (fallback)", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet when allGatesPassed is null (fallback)", () => {
    const result = selectModel(
      "powr-ship-verify",
  ...
  it("returns sonnet when both ticketCount and allGatesPassed are null", () => {
...
// ── Cross-cutting: every result has model + reason ──

describe("selectModel: all results have model and reason", () => {
  const agents = [
    "powr-investigate",
    "powr-code-review",
    "powr-ship-verify",
  ...
  for (const agent of agents) {
    it(`${agent} returns non-empty model and reason`, () => {
