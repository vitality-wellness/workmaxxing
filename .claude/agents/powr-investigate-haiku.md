...
tools: Read, Grep, Glob, Write, mcp__plugin_linear_linear__get_issue, mcp__plugin_linear_linear__list_issues
model: haiku
---
...
Write structured findings to `.claude/handoffs/investigate-<ticket_id>.md`:
...
Return exactly:
```
INVESTIGATION_COMPLETE: .claude/handoffs/investigate-<ticket_id>.md
