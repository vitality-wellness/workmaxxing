...
tools: Read, Bash, Grep, Glob, Write, mcp__plugin_linear_linear__list_issues, mcp__plugin_linear_linear__get_issue
model: haiku
---
...
Write to `.claude/handoffs/ship-<feature>.md`:
...
Return exactly:
```
SHIP_VERIFIED: .claude/handoffs/ship-<feature>.md
